        ...
        <div class="column navibar-menu">
          ...
          <ul class="navigator navibar-nav ">
            ...
            <li class="nav-item nav-item-dropdown">
              <a class="nav-link" href="products_brandname.php"><img src="images/menu_product.png"><br/><p>PRODUCT </p></a>
            </li>
            <li class="nav-item nav-item-dropdown">
              <a class="nav-link" href="promotion.php"><img src="images/menu_promotion.png"><br/><p>PROMOTIONS </p></a>
            </li>
            <li class="nav-item nav-item-dropdown">
              <a class="nav-link" href="character.php"><img src="images/menu_character.png"><br/><p>CHARACTER </p></a>
            </li>
            <li class="nav-item nav-item-dropdown">
              <a class="nav-link" href="stores.php"><img src="images/menu_stores.png"><br/><p>STORES </p></a>
            </li>
          </ul>
        </div>
